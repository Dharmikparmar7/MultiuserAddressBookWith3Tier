                ...
                <asp:GridView runat="server" ID="gvContact" OnRowCommand="gvContact_RowCommand" CssClass="table table-hover table-bordered border-2">
                    <Columns>
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" Text="Edit" NavigateUrl='<%# "~/AddressBook/AdminPanel/Contact/Edit/" + EncryptDecrypt.Base64Encode(Eval("ContactID").ToString()) %>' CssClass="btn btn-primary m-1"></asp:HyperLink>
