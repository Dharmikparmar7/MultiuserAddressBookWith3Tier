                ...
                <asp:GridView runat="server" ID="gvCity" OnRowCommand="gvCity_RowCommand" CssClass="table table-hover table-bordered border-2">
                    <Columns>
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" Text="Edit" NavigateUrl='<%# "~/AddressBook/AdminPanel/City/Edit/" + EncryptDecrypt.Base64Encode((Eval("CityID").ToString())) %>' CssClass="btn btn-primary"></asp:HyperLink>
