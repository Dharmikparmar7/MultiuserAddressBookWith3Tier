                ...
                <asp:GridView runat="server" ID="gvContactCategory" OnRowCommand="gvContactCategory_RowCommand" CssClass="table table-hover table-bordered border-2">
                    <Columns>
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" Text="Edit" NavigateUrl='<%# "~/AddressBook/AdminPanel/ContactCategory/Edit/" + EncryptDecrypt.Base64Encode(Eval("ContactCategoryID").ToString())
 %>'
