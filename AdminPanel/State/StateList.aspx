                ...
                <asp:GridView runat="server" ID="gvState" OnRowCommand="gvState_RowCommand" CssClass="table table-hover table-bordered border-2">
                    <Columns>
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" Text="Edit" NavigateUrl='<%# "~/AddressBook/AdminPanel/State/Edit/" + EncryptDecrypt.Base64Encode(Eval("StateID").ToString()) %>' CssClass="btn btn-primary"></asp:HyperLink>
