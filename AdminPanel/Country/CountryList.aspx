                ...
                <asp:GridView runat="server" ID="gvCountry" OnRowCommand="gvCountry_RowCommand" CssClass="table table-hover table-bordered border-2">
                    <Columns>
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:HyperLink runat="server" Text="Edit" NavigateUrl='<%# "~/AddressBook/AdminPanel/Country/Edit/" + EncryptDecrypt.Base64Encode(Eval("CountryID").ToString()) %>' CssClass="btn btn-primary"></asp:HyperLink>
